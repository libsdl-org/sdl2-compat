...
SDL2_PROTO(void,SetWindowIcon,(SDL_Window *a, SDL_Surface *b))
...
SDL2_PROTO(SDL_Surface*,GetWindowSurface,(SDL_Window *a))
...
SDL2_PROTO(SDL_Surface*,CreateRGBSurfaceWithFormat,(Uint32 a, int b, int c, int d, Uint32 e))
SDL2_PROTO(SDL_Surface*,CreateRGBSurfaceWithFormatFrom,(void *a, int b, int c, int d, int e, Uint32 f))
...
SDL2_PROTO(SDL_Surface*,DuplicateSurface,(SDL_Surface *a))
...
SDL2_PROTO(SDL2_AudioStream*,NewAudioStream,(const SDL_AudioFormat a, const Uint8 b, const int c, const SDL_AudioFormat d, const Uint8 e, const int f))
...
SDL2_PROTO(int,LockTextureToSurface,(SDL_Texture *a, const SDL_Rect *b, SDL_Surface **c))
...
SDL2_PROTO(SDL_bool,HasSurfaceRLE,(SDL_Surface *a))
...
#endif
SDL2_PROTO(int,GetAudioDeviceSpec,(int a, int b, SDL_AudioSpec *c))
...
SDL2_PROTO(int,GetDefaultAudioInfo,(char **a, SDL_AudioSpec *b, int c))
