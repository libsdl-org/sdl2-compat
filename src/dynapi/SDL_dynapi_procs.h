...
SDL_DYNAPI_PROC(int,SDL_BuildAudioCVT,(SDL_AudioCVT *a, SDL2_AudioFormat b, Uint8 c, int d, SDL2_AudioFormat e, Uint8 f, int g),(a,b,c,d,e,f,g),return)
...
SDL_DYNAPI_PROC(void,SDL_MixAudioFormat,(Uint8 *a, const Uint8 *b, SDL2_AudioFormat c, Uint32 d, int e),(a,b,c,d,e),)
...
SDL_DYNAPI_PROC(SDL_GUID,SDL_JoystickGetDeviceGUID,(int a),(a),return)
...
SDL_DYNAPI_PROC(SDL_Keycode,SDL_GetKeyFromScancode,(SDL2_Scancode a),(a),return)
SDL_DYNAPI_PROC(SDL2_Scancode,SDL_GetScancodeFromKey,(SDL_Keycode a),(a),return)
SDL_DYNAPI_PROC(const char*,SDL_GetScancodeName,(SDL2_Scancode a),(a),return)
SDL_DYNAPI_PROC(SDL2_Scancode,SDL_GetScancodeFromName,(const char *a),(a),return)
...
SDL_DYNAPI_PROC(int,SDL_SetPixelFormatPalette,(SDL2_PixelFormat *a, SDL_Palette *b),(a,b),return)
...
SDL_DYNAPI_PROC(Uint32,SDL_MapRGB,(const SDL2_PixelFormat *a, Uint8 b, Uint8 c, Uint8 d),(a,b,c,d),return)
SDL_DYNAPI_PROC(Uint32,SDL_MapRGBA,(const SDL2_PixelFormat *a, Uint8 b, Uint8 c, Uint8 d, Uint8 e),(a,b,c,d,e),return)
SDL_DYNAPI_PROC(void,SDL_GetRGB,(Uint32 a, const SDL2_PixelFormat *b, Uint8 *c, Uint8 *d, Uint8 *e),(a,b,c,d,e),)
SDL_DYNAPI_PROC(void,SDL_GetRGBA,(Uint32 a, const SDL2_PixelFormat *b, Uint8 *c, Uint8 *d, Uint8 *e, Uint8 *f),(a,b,c,d,e,f),)
...
SDL_DYNAPI_PROC(SDL_Renderer*,SDL_CreateSoftwareRenderer,(SDL2_Surface *a),(a),return)
...
SDL_DYNAPI_PROC(SDL_Texture*,SDL_CreateTextureFromSurface,(SDL_Renderer *a, SDL2_Surface *b),(a,b),return)
...
SDL_DYNAPI_PROC(SDL2_Surface*,SDL_CreateRGBSurface,(Uint32 a, int b, int c, int d, Uint32 e, Uint32 f, Uint32 g, Uint32 h),(a,b,c,d,e,f,g,h),return)
SDL_DYNAPI_PROC(SDL2_Surface*,SDL_CreateRGBSurfaceFrom,(void *a, int b, int c, int d, int e, Uint32 f, Uint32 g, Uint32 h, Uint32 i),(a,b,c,d,e,f,g,h,i),return)
SDL_DYNAPI_PROC(void,SDL_FreeSurface,(SDL2_Surface *a),(a),)
SDL_DYNAPI_PROC(int,SDL_SetSurfacePalette,(SDL2_Surface *a, SDL_Palette *b),(a,b),return)
SDL_DYNAPI_PROC(int,SDL_LockSurface,(SDL2_Surface *a),(a),return)
SDL_DYNAPI_PROC(void,SDL_UnlockSurface,(SDL2_Surface *a),(a),)
SDL_DYNAPI_PROC(SDL2_Surface*,SDL_LoadBMP_RW,(SDL2_RWops *a, int b),(a,b),return)
SDL_DYNAPI_PROC(int,SDL_SaveBMP_RW,(SDL2_Surface *a, SDL2_RWops *b, int c),(a,b,c),return)
SDL_DYNAPI_PROC(int,SDL_SetSurfaceRLE,(SDL2_Surface *a, int b),(a,b),return)
SDL_DYNAPI_PROC(int,SDL_SetColorKey,(SDL2_Surface *a, int b, Uint32 c),(a,b,c),return)
SDL_DYNAPI_PROC(int,SDL_GetColorKey,(SDL2_Surface *a, Uint32 *b),(a,b),return)
SDL_DYNAPI_PROC(int,SDL_SetSurfaceColorMod,(SDL2_Surface *a, Uint8 b, Uint8 c, Uint8 d),(a,b,c,d),return)
SDL_DYNAPI_PROC(int,SDL_GetSurfaceColorMod,(SDL2_Surface *a, Uint8 *b, Uint8 *c, Uint8 *d),(a,b,c,d),return)
SDL_DYNAPI_PROC(int,SDL_SetSurfaceAlphaMod,(SDL2_Surface *a, Uint8 b),(a,b),return)
...
SDL_DYNAPI_PROC(int,SDL_FillRect,(SDL2_Surface *a, const SDL_Rect *b, Uint32 c),(a,b,c),return)
SDL_DYNAPI_PROC(int,SDL_FillRects,(SDL2_Surface *a, const SDL_Rect *b, int c, Uint32 d),(a,b,c,d),return)
SDL_DYNAPI_PROC(int,SDL_UpperBlit,(SDL2_Surface *a, const SDL_Rect *b, SDL2_Surface *c, SDL_Rect *d),(a,b,c,d),return)
SDL_DYNAPI_PROC(int,SDL_LowerBlit,(SDL2_Surface *a, SDL_Rect *b, SDL2_Surface *c, SDL_Rect *d),(a,b,c,d),return)
...
SDL_DYNAPI_PROC(SDL2_TLSID,SDL_TLSCreate,(void),(),return)
SDL_DYNAPI_PROC(void*,SDL_TLSGet,(SDL2_TLSID a),(a),return)
SDL_DYNAPI_PROC(int,SDL_TLSSet,(SDL2_TLSID a, const void *b, void (SDLCALL *c)(void*)),(a,b,c),return)
...
SDL_DYNAPI_PROC(void,SDL_SetWindowIcon,(SDL_Window *a, SDL2_Surface *b),(a,b),)
...
SDL_DYNAPI_PROC(SDL2_Surface*,SDL_DuplicateSurface,(SDL2_Surface *a),(a),return)
...
SDL_DYNAPI_PROC(SDL2_AudioStream*,SDL_NewAudioStream,(const SDL2_AudioFormat a, const Uint8 b, const int c, const SDL2_AudioFormat d, const Uint8 e, const int f),(a,b,c,d,e,f),return)
...
SDL_DYNAPI_PROC(SDL2_bool,SDL_GameControllerHasSensor,(SDL_GameController *a, SDL_SensorType b),(a,b),return)
SDL_DYNAPI_PROC(int,SDL_GameControllerSetSensorEnabled,(SDL_GameController *a, SDL_SensorType b, SDL2_bool c),(a,b,c),return)
SDL_DYNAPI_PROC(SDL2_bool,SDL_GameControllerIsSensorEnabled,(SDL_GameController *a, SDL_SensorType b),(a,b),return)
...
SDL_DYNAPI_PROC(int,SDL_SoftStretchLinear,(SDL2_Surface *a, const SDL_Rect *b, SDL2_Surface *c, const SDL_Rect *d),(a,b,c,d),return)
#if defined(SDL_PLATFORM_WIN32) || defined(SDL_PLATFORM_WINGDK)
...
SDL_DYNAPI_PROC(void,SDL_SetWindowKeyboardGrab,(SDL_Window *a, SDL2_bool b),(a,b),)
SDL_DYNAPI_PROC(void,SDL_SetWindowMouseGrab,(SDL_Window *a, SDL2_bool b),(a,b),)
SDL_DYNAPI_PROC(SDL2_bool,SDL_GetWindowKeyboardGrab,(SDL_Window *a),(a),return)
SDL_DYNAPI_PROC(SDL2_bool,SDL_GetWindowMouseGrab,(SDL_Window *a),(a),return)
...
SDL_DYNAPI_PROC(void,SDL_SetWindowAlwaysOnTop,(SDL_Window *a, SDL2_bool b),(a,b),)
...
SDL_DYNAPI_PROC(SDL2_bool,SDL_JoystickHasRumble,(SDL_Joystick *a),(a),return)
SDL_DYNAPI_PROC(SDL2_bool,SDL_JoystickHasRumbleTriggers,(SDL_Joystick *a),(a),return)
SDL_DYNAPI_PROC(SDL2_bool,SDL_GameControllerHasRumble,(SDL_GameController *a),(a),return)
SDL_DYNAPI_PROC(SDL2_bool,SDL_GameControllerHasRumbleTriggers,(SDL_GameController *a),(a),return)
SDL_DYNAPI_PROC(void,SDL_hid_ble_scan,(SDL2_bool a),(a),)
...
SDL_DYNAPI_PROC(SDL2_bool,SDL_IsTextInputShown,(void),(),return)
SDL_DYNAPI_PROC(SDL2_bool,SDL_HasIntersectionF,(const SDL_FRect *a, const SDL_FRect *b),(a,b),return)
SDL_DYNAPI_PROC(SDL2_bool,SDL_IntersectFRect,(const SDL_FRect *a, const SDL_FRect *b, SDL_FRect *c),(a,b,c),return)
SDL_DYNAPI_PROC(void,SDL_UnionFRect,(const SDL_FRect *a, const SDL_FRect *b, SDL_FRect *c),(a,b,c),)
SDL_DYNAPI_PROC(SDL2_bool,SDL_EncloseFPoints,(const SDL_FPoint *a, int b, const SDL_FRect *c, SDL_FRect *d),(a,b,c,d),return)
SDL_DYNAPI_PROC(SDL2_bool,SDL_IntersectFRectAndLine,(const SDL_FRect *a, float *b, float *c, float *d, float *e),(a,b,c,d,e),return)
...
SDL_DYNAPI_PROC(SDL2_bool,SDL_HasLSX,(void),(),return)
SDL_DYNAPI_PROC(SDL2_bool,SDL_HasLASX,(void),(),return)
#if defined(SDL_PLATFORM_WIN32) || defined(SDL_PLATFORM_GDK)
...
SDL_DYNAPI_PROC(SDL2_bool,SDL_ResetHint,(const char *a),(a),return)
...
SDL_DYNAPI_PROC(SDL2_bool,SDL_HasPrimarySelectionText,(void),(),return)
...
#endif
SDL_DYNAPI_PROC(SDL2_bool,SDL_HasWindowSurface,(SDL_Window *a),(a),return)
