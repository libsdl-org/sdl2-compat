...
SDL3_SYM_PASSTHROUGH_RETCODE(SDL_bool,CaptureMouse,(SDL_bool a),(a),return)
...
SDL3_SYM_RENAMED_RETCODE(SDL_bool,GameControllerSetSensorEnabled,SetGamepadSensorEnabled,(SDL_GameController *a, SDL_SensorType b, SDL_bool c),(a,b,c),return)
