...
SDL3_SYM(int,GetDXGIOutputInfo,(SDL_DisplayID a,int *b, int *c),(a,b,c),return)
#endif
...
SDL3_SYM_RENAMED(int,AndroidSendMessage,SendAndroidMessage,(Uint32 a, int b),(a,b),return)
...
SDL3_SYM(int,RequestAndroidPermission,(const char *a, SDL_RequestAndroidPermissionCallback b, void *c),(a,b,c),return)
SDL3_SYM_RENAMED(int,AndroidShowToast,ShowAndroidToast,(const char *a, int b, int c, int d, int e),(a,b,c,d,e),return)
...
SDL3_SYM(int,ClearError,(void),(),return)
SDL3_SYM(int,OutOfMemory,(void),(),return)
...
SDL3_SYM(void *,AllocateTemporaryMemory,(size_t a),(a),return)
...
SDL3_SYM(const char*,GetGamepadMappingForGUID,(SDL_GUID a),(a),return)
...
SDL3_SYM(int,GetMasksForPixelFormat,(SDL_PixelFormat a, int *b, Uint32 *c, Uint32 *d, Uint32 *e, Uint32 *f),(a,b,c,d,e,f),return)
...
SDL3_SYM(SDL_Texture*,CreateTexture,(SDL_Renderer *a, SDL_PixelFormat b, int c, int d, int e),(a,b,c,d,e),return)
...
SDL3_SYM(int,SetSurfacePalette,(SDL_Surface *a, SDL_Palette *b),(a,b),return)
SDL3_SYM(int,LockSurface,(SDL_Surface *a),(a),return)
SDL3_SYM(void,UnlockSurface,(SDL_Surface *a),(a),)
SDL3_SYM(SDL_Surface*,LoadBMP_IO,(SDL_IOStream *a, SDL_bool b),(a,b),return)
SDL3_SYM(int,SaveBMP_IO,(SDL_Surface *a, SDL_IOStream *b, SDL_bool c),(a,b,c),return)
SDL3_SYM(int,SetSurfaceRLE,(SDL_Surface *a, SDL_bool b),(a,b),return)
SDL3_SYM(int,SetSurfaceColorKey,(SDL_Surface *a, SDL_bool b, Uint32 c),(a,b,c),return)
SDL3_SYM(int,GetSurfaceColorKey,(SDL_Surface *a, Uint32 *b),(a,b),return)
SDL3_SYM(int,SetSurfaceColorMod,(SDL_Surface *a, Uint8 b, Uint8 c, Uint8 d),(a,b,c,d),return)
SDL3_SYM(int,GetSurfaceColorMod,(SDL_Surface *a, Uint8 *b, Uint8 *c, Uint8 *d),(a,b,c,d),return)
SDL3_SYM(int,SetSurfaceAlphaMod,(SDL_Surface *a, Uint8 b),(a,b),return)
SDL3_SYM(int,GetSurfaceAlphaMod,(SDL_Surface *a, Uint8 *b),(a,b),return)
SDL3_SYM(int,SetSurfaceBlendMode,(SDL_Surface *a, SDL_BlendMode b),(a,b),return)
SDL3_SYM(int,GetSurfaceBlendMode,(SDL_Surface *a, SDL_BlendMode *b),(a,b),return)
...
SDL3_SYM(int,ConvertPixelsAndColorspace,(int a, int b, SDL_PixelFormat c, SDL_Colorspace d, SDL_PropertiesID e, const void *f, int g, SDL_PixelFormat h, SDL_Colorspace i, SDL_PropertiesID j, void *k, int l),(a,b,c,d,e,f,g,h,i,j,k,l),return)
SDL3_SYM(int,FillSurfaceRect,(SDL_Surface *a, const SDL_Rect *b, Uint32 c),(a,b,c),return)
SDL3_SYM(int,FillSurfaceRects,(SDL_Surface *a, const SDL_Rect *b, int c, Uint32 d),(a,b,c,d),return)
SDL3_SYM(int,BlitSurface,(SDL_Surface *a, const SDL_Rect *b, SDL_Surface *c, const SDL_Rect *d),(a,b,c,d),return)
SDL3_SYM(int,BlitSurfaceUnchecked,(SDL_Surface *a, const SDL_Rect *b, SDL_Surface *c, const SDL_Rect *d),(a,b,c,d),return)
SDL3_SYM(int,BlitSurfaceScaled,(SDL_Surface *a, const SDL_Rect *b, SDL_Surface *c, const SDL_Rect *d, SDL_ScaleMode e),(a,b,c,d,e),return)
...
SDL3_SYM(int,SetTLS,(SDL_TLSID *a, const void *b, SDL_TLSDestructorCallback c),(a,b,c),return)
...
SDL3_SYM(const SDL_TouchID*,GetTouchDevices,(int *a),(a),return)
SDL3_SYM(const SDL_Finger* const*,GetTouchFingers,(SDL_TouchID a, int *b),(a,b),return)
...
SDL3_SYM(int,CloseIO,(SDL_IOStream *a),(a),return)
...
SDL3_SYM(int,LockTextureToSurface,(SDL_Texture *a, const SDL_Rect *b, SDL_Surface **c),(a,b,c),return)
...
SDL3_SYM(const SDL_Locale * const*,GetPreferredLocales,(int *a),(a),return)
...
SDL3_SYM(const void*,GetWindowICCProfile,(SDL_Window *a, size_t *b),(a,b),return)
...
SDL3_SYM(const char *,GUIDToString,(SDL_GUID a),(a),return)
...
SDL3_SYM(const SDL_JoystickID*,GetJoysticks,(int *a),(a),return)
...
SDL3_SYM(const SDL_JoystickID*,GetGamepads,(int *a),(a),return)
...
SDL3_SYM(const SDL_SensorID *,GetSensors,(int *a),(a),return)
...
SDL3_SYM(const SDL_DisplayID*,GetDisplays,(int *a),(a),return)
...
SDL3_SYM(const SDL_DisplayMode * const*,GetFullscreenDisplayModes,(SDL_DisplayID a, int *b),(a,b),return)
...
SDL3_SYM(const SDL_AudioDeviceID*,GetAudioPlaybackDevices,(int *a),(a),return)
SDL3_SYM(const SDL_AudioDeviceID*,GetAudioRecordingDevices,(int *a),(a),return)
...
SDL3_SYM(const SDL_GamepadBinding * const*,GetGamepadBindings,(SDL_Gamepad *a, int *b),(a,b),return)
SDL3_SYM(int,SetPointerProperty,(SDL_PropertiesID a, const char *b, void *c),(a,b,c),return)
SDL3_SYM(int,SetPointerPropertyWithCleanup,(SDL_PropertiesID a, const char *b, void *c, SDL_CleanupPropertyCallback d, void *e),(a,b,c,d,e),return)
...
SDL3_SYM(const SDL_HapticID *,GetHaptics,(int *a),(a),return)
...
SDL3_SYM(SDL_Window * const*,GetWindows,(int *a),(a),return)
